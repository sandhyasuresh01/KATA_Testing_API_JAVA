...
public class MergeFrom {
    ...
    private static templates.FreemarkerTemplate freemarkerTemplate = new FreemarkerTemplate();

    public MergeFrom(String templateFile) {
        this.templateFile = templateFile;
    }

    public static templates.MergeFrom template(String template) {
        return new templates.MergeFrom(template);
    }

    public templates.MergeFrom withDefaultValuesFrom(Map<String, String> defaultValues) {
